...
def test_diff_lines():
    ...
    expected = [ {"state": 'deleted', 'lineno': 0, 'value': u'x'},
                 {"state": 'empty', 'lineno': 0, 'value': ''},
                 {"state": 'empty', 'lineno': 1, 'value': ''},
                 {"state": 'added', 'lineno': 1, 'value': u'z = {1, 2, 3} \n'},
                 {"state": 'unchanged', 'lineno': 2, 'value': u'x = [1,3,3]\n'},
                 {"state": 'unchanged', 'lineno': 2, 'value': u'x = [1,3,3]\n'},
                 {"state": 'deleted', 'lineno': 3, 'value': u'z = {1, 2, 3} \n'},
                 {"state": 'empty', 'lineno': 3, 'value': ''},
                 {"state": 'unchanged', 'lineno': 4, 'value': u'\n'},
                 {"state": 'unchanged', 'lineno': 4, 'value': u'\n'}
                 ]
    eq_(result, expected)
